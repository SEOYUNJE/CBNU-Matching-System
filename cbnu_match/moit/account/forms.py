...
class SignupForm(forms.Form):
    ...
    first_name = forms.CharField(label="이름", widget=forms.TextInput(attrs={'placeholder': '이름 입력'}))
    last_name = forms.CharField(label="성", widget=forms.TextInput(attrs={'placeholder': '성 입력'}))
